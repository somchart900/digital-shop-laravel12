...
class __TwigTemplate_53b417747a80846cea485326dd27deb2 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "C:\\WebServ\\Project\\public\\phpMyAdmin\\templates\\preferences\\header.twig");
    }
}
